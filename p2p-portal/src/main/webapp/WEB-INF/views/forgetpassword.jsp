...
<script src="${ctx}/static/script/forgetpassword.js" type="text/javascript"></script>
...
<body>
	...
	<div class="tdbModule register">
		...
		<div class="registerCont">
			<form action="forgetpassword" id="updatepasswordForm" method="post">
				<ul>
					...
					<li><label for="userPassword" class="dis">新密码:</label> <input type="password"
						name="userPassword" id="userPassword" class="input _password"
						maxlength="50" tabindex="1"> </li>
					<li><span class="dis">确认新密码:</span> <input type="password"
					...
					<li class="telNumber"><span class="dis">短信验证码:</span> <input
						...
						tabindex="1"> </li>					
					<li class="btn"><a
						href="javascript:void(0);" id="updatepasswordFormSubmit">下一步</a></li>
				</ul>
			</form>
		</div>

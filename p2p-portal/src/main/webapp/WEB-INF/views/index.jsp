...
<jsp:include page="/top.jsp">
    <jsp:param value="title" name="index"/>
</jsp:include>
	<!--banner-->
	<div class="flexslider">
		<ul class="slides">
			<li
				style="background-image: url(${ctx}/static/images/banner.jpg); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1; background-position: 50% 0px; background-repeat: no-repeat no-repeat;"
				class=""><a href="#" target="_blank"></a></li>
			<li
				style="background-image: url(${ctx}/static/images/banner1.jpg); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1; background-position: 50% 0px; background-repeat: no-repeat no-repeat;"
				class=""><a href="#" target="_blank"></a></li>
			<li
				style="background-image: url(${ctx}/static/images/banner2.jpg); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1; background-position: 50% 0px; background-repeat: no-repeat no-repeat;"
				class=""><a href="#" target="_blank"></a></li>
			<li
				style="background-image: url(${ctx}/static/images/banner3.jpg); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1; background-position: 50% 0px; background-repeat: no-repeat no-repeat;"
				class=""><a href="# " target="_blank"></a></li>
			<li
				style="background-image: url(${ctx}/static/images/banner4.jpg); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1; background-position: 50% 0px; background-repeat: no-repeat no-repeat;"
				class=""><a href="#" target="_blank"></a></li>
		</ul>
	</div>
	<script src="${ctx}/static/script/jquery.flexslider-min.js"></script>
	<script>
		$(function() {
		...
		<div class="new-announcement-content">
			<div id="scrollDiv">
				<ul style="margin-top: 0px;">
					<li><a class="black-link" href="公司公告详细.html" target="_blank">
							2015年9月8日还款公告</a></li>
					<li><a class="black-link" href="公司公告详细.html" target="_blank">
		...
		<div class="wrap">
			<div class="page-left fn-left">
				<div class="mod-borrow">
					...
					<div class="bd">
						<div class="des">
							<span class="fn-left">期限1-29天，期限短，收益见效快</span><a href="list.html"
							...
							<ul>
								<li>
									<div class="title">
										<a href="infor.html" target="_blank"><i
											...
											class="f18" title="金女士债权质押借款1万元" target="_blank">金女士债权质押借款1万元</a>
									</div>
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tbody>
											<tr>
												<td width="260">借款金额<span class="f24 c-333">10000.00</span>元
												</td>
												<td width="165">年利率<span class="f24 c-333">10.70%
												</span></td>
												<td width="180" align="center">期限<span
													class="f24 c-orange">4</span>天
												</td>
												<td><div class="circle">
												...
												<td align="right"><a class="ui-btn btn-gray" href="#">还款中</a>
												</td>
											</tr>
										</tbody>
									</table>
								...
								<li>
									<div class="title">
										<a href="infor.html" target="_blank"><i
											class="icon icon-zhai" title="债权贷"></i></a><a href="infor.html"
											class="f18" title="周先生债权质押借款0.1万元" target="_blank">周先生债权质押借款0.1万元</a>
									</div>
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tbody>
											<tr>
												<td width="260">借款金额<span class="f24 c-333">1000.00</span>元
												</td>
												<td width="165">年利率<span class="f24 c-333">10.85%
												</span></td>
												<td width="180" align="center">期限<span
													class="f24 c-orange">7</span>天
												</td>
												<td><div class="circle">
														<div class="left progress-bar">
				...
				<div class="mod-borrow mrt20">
					...
					<div class="bd">
						<div class="des">
							<span class="fn-left">期限1-12月，收益更高</span><a href="list.html"
								class="fn-right">查看更多&gt;&gt;</a>
						</div>
						<div class="borrow-list">
							<ul>
								<li>
									<div class="title">
										<a href="#" target="_blank"><i class="icon icon-che"
											title="车易贷"></i></a><a href="infor.html" class="f18"
											title="毕先生宝马320汽车质押贷款10万元" target="_blank">毕先生宝马320汽车质押贷款10万元</a>
									</div>
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tbody>
											<tr>
												<td width="260">借款金额<span class="f24 c-333">100000.00</span>元
												</td>
												<td width="165">年利率<span class="f24 c-orange relative">12.00%
														<!--公益标 20150724 lj--> <!--公益标 20150724 lj-->
												</span></td>
												<td width="180" align="center">期限<span
													class="f24 c-333">1</span>个月
												</td>
												<td><div class="circle">
														<div class="left progress-bar">
								...
								<li>
									<div class="title">
										<a href="infor.html" target="_blank"><i
											class="icon icon-che" title="车易贷"></i></a><a href="#" class="f18"
											title="王先生克莱斯勒300C汽车质押贷款15万元" target="_blank">王先生克莱斯勒300C汽车质押贷款15万元</a>
									</div>
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tbody>
											<tr>
												<td width="260">借款金额<span class="f24 c-333">150000.00</span>元
												</td>
												<td width="165">年利率<span class="f24 c-orange relative">12.00%
														<!--公益标 20150724 lj--> <!--公益标 20150724 lj-->
												</span></td>
				...
				<div class="mod-borrow mrt20">
					...
					<div class="bd">
						<div class="des">
							<span class="fn-left">期限12-60月，打理更加容易</span><a href="list.html"
								class="fn-right">查看更多&gt;&gt;</a>
						</div>
						<div class="borrow-list">
							<ul>
								<li>
									<div class="title">
										<a href="infor.html" target="_blank"><i
											class="icon icon-che" title="车易贷"></i></a><a href="infor.html"
											class="f18" title="朱先生比亚迪S6汽车抵押贷款4.5万元" target="_blank">朱先生比亚迪S6汽车抵押贷款4.5万元</a>
									</div>
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tbody>
											<tr>
												<td width="260">借款金额<span class="f24 c-333">45000.00</span>元
												</td>
												<td width="165">年利率<span class="f24 c-orange relative">13.80%
														<!--公益标 20150724 lj--> <!--公益标 20150724 lj-->
												</span></td>
												<td width="180" align="center">期限<span
													class="f24 c-333">18</span>个月
												</td>
												<td><div class="circle">
														<div class="left progress-bar">
								...
								<li>
									<div class="title">
										<a href="infor.html" target="_blank"><i
											class="icon icon-che" title="车易贷"></i></a><a href="infor.html"
											class="f18" title="朱先生别克英朗汽车抵押贷款5万元" target="_blank">朱先生别克英朗汽车抵押贷款5万元</a>
									</div>
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tbody>
											<tr>
												<td width="260">借款金额<span class="f24 c-333">50000.00</span>元
												</td>
												<td width="165">年利率<span class="f24 c-orange relative">13.80%
														<!--公益标 20150724 lj--> <!--公益标 20150724 lj-->
												</span></td>
					...
					<div class="bd">
						<div class="des">
							<span class="fl">其他投资人折价转让，转让项目会随时更新，惊喜不断</span><a
								href="list.html" class="fn-right">查看更多&gt;&gt;</a>
						</div>
						<div class="borrow-list">
							<ul>
								<li>
									<div class="title">
										<a href="infor.html" target="_blank"><i
											class="icon icon-zhuan" title="债权转让"></i></a><a href="infor.html"
											title="汪女士债权质押借款1万元" class="f18" target="_blank">汪女士债权质押借款1万元</a>
									</div>
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tbody>
											<tr>
												<td width="260" height="60">剩余期限<span class="f24 c-333">
														2月8天 </span></td>
												<td width="200">预期收益率<span class="f24"><a
														href="javascript:;" class="tx-line c-orange"
														onClick="showCalculator(this,12.42,84890,10068.17)"
														title="点击查看纯收益率">12.42%</a></span></td>
												<td width="280" align="center">转让价格<span
													class="f24 c-333">10,068.17</span>元
												</td>
												<td width="88" align="right" class="time"><a href="#"
													class="ui-btn btn-gray" target="_blank">已转让</a>
			...
			<div class="page-right fn-right" style="top: 0px;">
				<div class="mod-risk-tip">
					<i class="icon icon-tip"></i><a href="/bxbz/index.html"
						class="c-orange">收益与风险并存，请理性选择平台</a>
				</div>
				<div class="mod mod-notice mrt20">
					<div class="hd">
						<h3>网站公告</h3>
						<a href="/gonggao/news/index.html" class="fn-right">更多&gt;</a>
					</div>
					<div class="bd">
						<div class="article-list clearfix">
							<ul>
								<li><a href="#" title="关于“金融产品”产品的说明">关于“金融产品”产品的说明</a><span
									class="date">06-19</span></li>
								<li><a href="#" title="2015年9月10日发标预告">2015年9月10日发标预告</a><span
								...
								<li><a href="#" title="关于P2P理财平台新系统升级的公告">关于P2P理财平台新系统***</a><span
									class="date">09-02</span></li>
								<li><a href="#" title="关于债权贷新规调整实施的公告">关于债权贷新规调整实施的公告</a><span
									class="date">08-25</span></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="mrt20 mod">
					<a href="#"><img src="${ctx}/static/images/pic_home_js.jpg"
						width="300" height="80" alt="收益计算器" class="pic"></a>
				</div>
			</div>
		</div>
	</div>
	<script src="${ctx}/static/script/index.js"></script>
				...
				<div class="ui-tab-cont">
					<div class="ui-tab-item active">
						<div class="img-scroll">
							<div class="container">
								<ul>
									<li><img src="${ctx}/static/images/logo_sbcvc.png" width="152"
										height="52" alt="软银"></li>
									<li><img src="${ctx}/static/images/logo_abc.png" width="152"
										height="52" alt="农业银行"></li>
									<li><img src="${ctx}/static/images/logo_wdzj.png" width="152"
										height="52" alt="网贷之家"></li>
									<li><img src="${ctx}/static/images/logo_baidu.png" width="152"
										height="52" alt="百度"></li>
									<li><img src="${ctx}/static/images/logo_aqb.png" width="152"
										height="52" alt="安全宝"></li>
									<li><img src="${ctx}/static/images/logo_gds.png" width="152"
										height="52" alt="万国数据"></li>
								</ul>
							</div>
						</div>
					</div>

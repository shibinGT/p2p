						...
						<div class="user-head">
							<span id="clickHeadImage" class="head-img" title="点击更换头像">
								<form method="post" action="">
									<input type="hidden" name="userPhotoUploadForm"
										value="userPhotoUploadForm"> <span
										id="userPhotoUploadForm:photo"><img
										id="userPhotoUploadForm:photoImage" src="${ctx}/static/images/touxiang.png"
										alt="" style="width: 88px; height: 88px; z-index: 0;"> <i
										class="headframe" style="z-index: 0;"></i>-
										<div id="userPhotoUploadForm:shangchuan-btn"
											class="ui-fileupload ui-widget" style="z-index: 0;">
											<div class="ui-fileupload-buttonbar ui-corner-top">
												<span
													...
													class="ui-button-text ui-c"></span> <input type="file"
													id="userPhotoUploadForm:shangchuan-btn_input"
													name="userPhotoUploadForm:shangchuan-btn_input"
					...
					<div class="pmain-money">
						<ul>
							...
							<li><span><em>待收本息</em><i id="dsbx" class="markicon"></i><span
								...
								class="truemoney"><i class="f26 fb">${accountDuePrincipalAndEarnings} </i>元</span></li>
							<li><span><em>累计收益</em><i id="ljsy" class="markicon"></i><span
								...
								class="truemoney"><i class="f26 fb c-pink">${account.accountAccumulatedEarnings} </i> 元</span></li>
						</ul>
					</div>
				</div>
					...
					<div class="pmain-conmain" id="pmain-conmain">
						<div class="pmain-conmain1">
							...
							<ul style="float: left;">
								...
								<c:forEach items="${returnList}" var="plan">
									<li><span class="pmain-titledate">${plan.returnedMoneyContractDate}</span><span
									class="pmain-titleproject">宝马汽车借贷业务</span><span
									class="pmain-titletype">债权转让</span><span
									class="pmain-titlemoney">${plan.returnedMoneyMoney}</span></li>
								</c:forEach>
								<!--<div style=" width:
						...
						<div class="pmain-conmain2" style="display: none;">
							...
							<ul style="float: left;">
								...
								<c:forEach items="${record}" var="transactionRecord">
								<li><span class="pmain-titledate">${transactionRecord.transactionRecordDate }</span><span
									class="pmain-w100">${transactionRecord.transactionRecordType }</span><span
									class="pmain-w120 pmain-money">${transactionRecord.transactionRecordAmount }</span><span
									class="pmain-w120 pmain-money">${transactionRecord.transactionRecordAvailableCapital }</span><span
									class="pmain-w200">${transactionRecord.transactionRecordComment }</span></li>
								</c:forEach>

...
<link rel="stylesheet" type="text/css"
	href="${ctx}/static/css/jquery.datetimepicker.css" />
	...
	<div class="header min-width">
		<div class="container">
			...
			<ul class="top-nav fn-clear">
				...
				<li class="top-nav-safe"><a href="${ctx}/user/userIndex">我的账户</a></li>
	...
	border: 1px solid #ccc;
				...
				<div class="personal-zhsz">
					...
					<ul>
						<li><i class="grzxbg p-right"></i><span class="zhsz-span1">手机号</span><span
							class="zhsz-span2">150****0139</span><span class="zhsz-span3"><a
								href="javascript:void(0)"
								onclick="showSpan('alert-checkOldMobile')">更改</a></span></li>
						<input type="hidden" value="false" id="authenticationMobile">
						<li><i class="grzxbg p-danger"></i><span class="zhsz-span1">身份认证</span><span
							class="zhsz-span2">未认证</span><span class="zhsz-span3"><a
								href="#">认证</a></span></li>
						...
						<li><i class="grzxbg p-right"></i> <span class="zhsz-span1">电子邮箱</span>
							<span class="zhsz-span2">348****@qq.com</span> <span
			...
			<script type="text/javascript">
				...
				function s7Code(xhr, status, args, args2) {
					if (!args.validationFailed) {
						...
						flag = true;
						var mobileNumber = $(
								"#checkOldMobileForm\\:oldMobileNumber").html()
								.replace(/(^\s*)|(\s*$)/g, "");
						if ("dx" == args2) {
							$("#mobileMsg").html(
									mobileNumber.substring(0, 3) + "****"
				...
				function checkOldMobileFormAuthCode() {
					...
					var authCode = $(
							"#checkOldMobileForm\\:checkOldMobileFormauthCode")
							.val();
					var nullFlag = (authCode == "");
					if (nullFlag) {
						$(
						...
						if (!legalFlag) {
							...
							$("#checkOldMobileFormauthCodeErrorDiv").append(
									$span);
							return false;
						} else {
							$(
				...
				$(document)
						.ready(
								function() {
									var valiCodeError = $("#valiCodeError")
											.val();
									if (valiCodeError.length > 0) {
										$(
												"#checkOldMobileForm\\:checkOldMobileFormauthCode_message")
												.remove();
										var $span = $("<span id=checkOldMobileForm\:checkOldMobileFormauthCode_message class=error>"
												+ valiCodeError + "</span>");
										$("#checkOldMobileFormauthCodeErrorDiv")
												.append($span);
									}
								});
				//]]>
						...
						<ul>
							<li><label class="txt-name">原手机号</label> <label
								id="checkOldMobileForm:oldMobileNumber" class="txt240">
									150****0139</label></li>
							<li><label class="txt-name">验证码</label> <input
								id="checkOldMobileForm:checkOldMobileFormauthCode" type="text"
								name="checkOldMobileForm:checkOldMobileFormauthCode"
								class="txt110" maxlength="8"
								onblur="jsf.util.chain(this,event,'return checkOldMobileFormAuthCode()','mojarra.ab(this,event,\'blur\',0,\'@this\')')"
								onfocus="clearValue(this)" placeholder="请输入验证码"> <span
								id="sendCode7"><a id="checkOldMobileForm:sendAuthCodeBtn"
									href="#"
									onclick="jsf.util.chain(this,event,'return validateModifyPhoneSMS(\'15055100139\');','PrimeFaces.ab({source:this,event:\'action\',process:\'checkOldMobileForm:sendAuthCodeBtn checkOldMobileForm:oldMobileNumber\',oncomplete:function(xhr,status,args){s7Code(xhr, status, args, \'dx\');}}, arguments[1]);');return false"
									class="btn-code">免费获取校验码</a><a
									id="checkOldMobileForm:sendAuthCodeBtn7" href="#"
									style="display: none;"
									onclick="mojarra.ab(this,event,'action','checkOldMobileForm:oldMobileNumber',0,{'onevent':sCode7()});return false"
									class="btn-code">免费获取校验码</a> </span> <span id="sendCodeGrey7"
								style="display: none;"> <a href="#" id="sendAuthCodeBtn7"
									class="btn-codeAfter" style="cursor: default;">免费获取校验码</a>
							</span>
								<div id="checkOldMobileFormauthCodeErrorDiv"
									class="alert-error120"></div>
								<div id="authCodeMsg" style="display: none;" class="yzmplace">
									验证码已发送到您手机<span id="mobileMsg"></span>，如果收不到短信，请 <a
										id="checkOldMobileForm:sendAuthCodeBtn3" href="#"
										style="color: blue;"
										onclick="PrimeFaces.ab({source:this,event:'action',process:'checkOldMobileForm:sendAuthCodeBtn3 checkOldMobileForm:oldMobileNumber',oncomplete:function(xhr,status,args){s7Code(xhr, status, args, 'yy');}}, arguments[1]);;return false">语音获取</a>
								</div>
								<div id="authCodeMsg2" style="display: none;" class="yzmplace">
									您的手机<span id="mobileMsg2"></span>将在60秒内收到语音电话，请接听！
								</div></li>
							<li><span class="txt-right" style="display: none;"><i
									class="error-icon"></i><i class="error-tip">验证码错误请重新输入</i></span><br>
								<input type="submit" name="checkOldMobileForm:j_idt129"
								value="确 认" class="btn-ok txt-right"
								onclick="return checkCheckOldMobileAll()"></li>
						</ul>
			...
			<script type="text/javascript">
				...
				function checkUpdateMobileFormMoible() {
					...
					var nullFlag = (mobile == "");
					if (nullFlag) {
						$("#updateMonbileForm\\:mobileNumber2_message")
								.remove();
						...
						if (mobile2 == mobile) {
							...
							$("#mobileNumber2ErrorDiv").append($span);
							$("#sendCode1").hide();
							$("#sendAuthCodeBtn2").css("background-color",
									"#FF736C");
							$("#sendCodeGrey1").show();
							return false;
						} else {
				...
				function checkUpdateMonbileFormAuthCode() {
					var mobile = $(
							"#updateMonbileForm\\:updateMonbileFormauthCode")
							.val();
					var nullFlag = (mobile == "");
					...
					if (nullFlag) {
						...
						var authCodeError = $(
								"#updateMonbileFormauthCodeErrorDiv").text();
						if (authCodeError == '请输入验证码') {
							$(
									"#updateMonbileForm\\:updateMonbileFormauthCode_message")
									.remove();
					...
					<form id="updateMonbileForm" name="updateMonbileForm" method="post"
						...
						<ul>
							...
							<li><span class="txt-right" style="display: none;"><i
								...
								class="btn-ok txt-right" onclick="return updateMobileAll()">
							</li>
						</ul>
						<input type="hidden" name="javax.faces.ViewState"
							id="javax.faces.ViewState"
			...
			<div class="alert-450" id="alert-updateEmail" style="display: none;">
					...
					<form id="changeEmailForm" name="changeEmailForm" method="post"
						...
						<ul>
							<li><label class="txt-name">请输入新邮箱</label> <input
								...
								id="changeEmailForm:newEmail" type="text"
								name="changeEmailForm:newEmail" class="txt235"
							...
							<li><label class="txt-name">手机验证码</label> <input
								id="changeEmailForm:changeEmailFormauthCode" type="text"
								name="changeEmailForm:changeEmailFormauthCode" class="txt110"
								maxlength="8" onblur="mojarra.ab(this,event,'blur',0,0)"
								placeholder="请输入手机验证码"> <span id="sendCode2"><a
									id="changeEmailForm:sendAuthCodeBtn" href="#"
									onclick="jsf.util.chain(this,event,'return validateMailSMS(\'15055100139\');','PrimeFaces.ab({source:this,event:\'action\',process:\'changeEmailForm:sendAuthCodeBtn changeEmailForm:newEmail\',oncomplete:function(xhr,status,args){s3Code(xhr, status, args, \'dx\');}}, arguments[1]);');return false"
									class="btn-code">免费获取校验码</a><a
									id="changeEmailForm:sendAuthCodeBtn6" href="#"
									style="display: none;"
									onclick="mojarra.ab(this,event,'action','@this changeEmailForm:newEmail',0,{'onevent':sCode3});return false"
									class="btn-code">免费获取校验码</a> </span> <span id="sendCodeGrey2"
								style="display: none;"> <a href="#" id="sendAuthCodeBtn3"
									class="btn-codeAfter" style="cursor: default;">免费获取校验码</a>
							</span></li>
							<li>
								<div id="changeEmailFormauthCodeErrorDiv" class="errorplace"></div>
								<div id="authCodeMsg5" style="display: none;" class="yzmplace1">
									验证码已发送到您手机<span id="mobileMsg5"></span>，如果收不到短信，请 <a
										id="changeEmailForm:sendAuthCodeBtn4" href="#"
										style="color: blue;"
										onclick="PrimeFaces.ab({source:this,event:'action',process:'changeEmailForm:sendAuthCodeBtn4 changeEmailForm:newEmail',oncomplete:function(xhr,status,args){s3Code(xhr, status, args, 'yy');}}, arguments[1]);;return false">语音获取</a>
								</div>
								<div id="authCodeMsg6" style="display: none;" class="yzmplace1">
									您的手机<span id="mobileMsg6"></span>将在60秒内收到语音电话，请接听！
								</div> <input type="submit" name="changeEmailForm:j_idt150"
								value="确　认" class="btn-ok txt-right"
								onclick="return changeEmailFormAll()">
							</li>
						</ul>
						<input type="hidden" name="javax.faces.ViewState"
							id="javax.faces.ViewState"
				...
				<div class="alert-main" id="alert-main2"
					...
					<div class="about-con">
						<ul>
							<li><br> <span style="margin-left: 80px;">请您先完成手机绑定，再进行邮箱更改！</span>
							</li>
			...
			<script type="text/javascript">
				...
				function checkbandingEmailFormEmail() {
					...
					if (nullFlag) {
						...
						if (error == '请先输入邮箱') {
							$("#bandingEmail\\:bandingEmailemail_message")
									.remove();
						}
					}
					return true;
			...
			<script type="text/javascript">
				...
				function checkactiveEmailFormEmail() {
					...
					if (nullFlag) {
						...
						if (error == '请输入邮箱')
							$("#activeEmail\\:activeEmailemail_message")
									.remove();
					}
					return true;
				}
					...
					<form id="activeEmail" name="activeEmail" method="post" action=""
						...
						<ul>
							<li><label class="txt-name">邮箱</label> <input
								...
								name="activeEmail:activeEmailemail" value="348705622@qq.com"
								class="txt235"
					...
					<form id="updatePassForm" name="updatePassForm" method="post"
						...
						<ul>
							<li><label class="txt-name">请输入原密码</label> <input
								id="updatePassForm:oldPassword" type="password"
								name="updatePassForm:oldPassword" value="" maxlength="20"
							...
							<li><label class="txt-name">请输入新密码</label> <input
								id="updatePassForm:password" type="password"
								name="updatePassForm:password" value="" maxlength="20"
							...
							<li><label class="txt-name">请确认新密码</label> <input
								id="updatePassForm:repassword" type="password"
								name="updatePassForm:repassword" value="" maxlength="20"
								onblur="return checkRepassword()" class="txt235">
							...
							<li><input type="submit" name="updatePassForm:j_idt174"
								...
								onclick="return checkupdatePassFormAll()"></li>
						</ul>
					</form>
				</div>
				<script type="text/javascript">
					...
					if (window.ActiveXObject) {
						...
						if (browser == "Microsoft Internet Explorer"
							...
							$("#checkMonbileForm\\:sendAuthCodeBtn4").css(
									"display", "block");
							$("#checkMonbileForm\\:sendAuthCodeBtn").css(
									"display", "none");
							$("#updateMonbileForm\\:sendAuthCodeBtn5").css(
									"display", "block");
							$("#updateMonbileForm\\:sendAuthCodeBtn").css(
									"display", "none");
							$("#changeEmailForm\\:sendAuthCodeBtn6").css(
									"display", "block");
							$("#changeEmailForm\\:sendAuthCodeBtn").css(
									"display", "none");
							$("#checkOldMobileForm\\:sendAuthCodeBtn7").css(
									"display", "block");
							$("#checkOldMobileForm\\:sendAuthCodeBtn").css(
									"display", "none");
						}
					}
					function sCode2() {
						var mobile = $("#checkMonbileForm\\:mobileNumber")
								.val();
					...
					function sCode4() {
						var mobile = $("#updateMonbileForm\\:mobileNumber2")
								.val();
						var mobileRegex = "^1[3|4|5|7|8][0-9]{9}$";
						var mobilePattern = new RegExp(mobileRegex);
						var mobileFlag = mobilePattern.test(mobile);
					...
					if (ua.indexOf("Windows NT 5") != -1) {
						if (window.ActiveXObject) {
							...
							var trim_Version = version[1].replace(/[ ]/g, "");
							if (browser == "Microsoft Internet Explorer"
									&& (trim_Version == "MSIE8.0" || trim_Version == "MSIE7.0")) {
								$("#checkMonbileForm\\:sendAuthCodeBtn4").css(
										"display", "block");
								$("#checkMonbileForm\\:sendAuthCodeBtn").css(
										"display", "none");
								...
								$("#changeEmailForm\\:sendAuthCodeBtn").css(
										"display", "none");
								$("#checkOldMobileForm\\:sendAuthCodeBtn7")
										.css("display", "block");
								$("#checkOldMobileForm\\:sendAuthCodeBtn").css(
										"display", "none");
							}
									...
									success : function(data) {
										if (data.flag == 'NO') {
											$(
													"#checkOldMobileForm\\:checkOldMobileFormauthCode_message")
													.remove();
											var $span = $("<span id=checkOldMobileForm\:checkOldMobileFormauthCode_message class=alerterror>点击过于频繁,请<b>"
													+ data.second
													+ "</b>秒后重试</span>");
											$(
													"#checkOldMobileFormauthCodeErrorDiv")
											...
											$(
													"#checkOldMobileForm\\:checkOldMobileFormauthCode_message")
													.remove();
											var $span = $("<span id=checkOldMobileForm\:checkOldMobileFormauthCode_message class=alerterror>"
													+ data.smsVali + "</span>");
											$(
													"#checkOldMobileFormauthCodeErrorDiv")
													.append($span);
									...
									success : function(data) {
										if (data.flag == 'NO') {
											$(
													"#changeEmailForm\\:changeEmailFormauthCode_message")
													.remove();
											var $span = $("<span id=changeEmailForm\:changeEmailFormauthCode_message class=alerterror>点击过于频繁,请<b>"
													+ data.second
													+ "</b>秒后重试</span>");
											$(
													"#changeEmailFormauthCodeErrorDiv")
											...
											$(
													"#changeEmailForm\\:changeEmailFormauthCode_message")
													.remove();
											var $span = $("<span id=changeEmailForm\:changeEmailFormauthCode_message class=alerterror>"
													+ data.smsVali + "</span>");
											$(
													"#changeEmailFormauthCodeErrorDiv")
													.append($span);
						...
						$
								.ajax({
									...
									success : function(data) {
										if (data.flag == 'NO') {
											$(
													"#checkMonbileForm\\:authCode_message")
													.remove();
											var $span = $("<span id=checkMonbileForm\:authCode_message class=alerterror>点击过于频繁,请<b>"
													+ data.second
													+ "</b>秒后重试</span>");
											$("#authCodeErrorDiv")
													.append($span);
											...
											$(
													"#checkMonbileForm\\:authCode_message")
													.remove();
											var $span = $("<span id=checkMonbileForm\:authCode_message class=alerterror>"
													+ data.smsVali + "</span>");
											$("#authCodeErrorDiv")
													.append($span);
											returnResult = false;
		...
		<div class="ft-inner clearfix">
			...
			<div class="ft-wap clearfix">
				<dl>
					<dt>官方二维码</dt>
					<dd>
						<span class="icon-ft-erweima"><img src=" ${ctx}/static/images/code.png"
